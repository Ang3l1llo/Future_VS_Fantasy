	...
	if velocity.length() > 0:
		...
		if velocity.x != 0:
			...
			if facing_right:
				...
				attack_shape1.position = Vector2(45.5, attack_shape1.position.y)
				attack_shape2.position = Vector2(47.5, attack_shape2.position.y)
				attack_shape3.position = Vector2(54, attack_shape3.position.y)
				...
				attack_shape2.scale.x = -1
				attack_shape3.scale.x = -1
				attack_shape1.position = Vector2(26, attack_shape1.position.y)  
				attack_shape2.position = Vector2(23.5, attack_shape2.position.y) 
				attack_shape3.position = Vector2(16.5, attack_shape3.position.y)
