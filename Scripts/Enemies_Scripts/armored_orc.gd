	...
	if velocity.length() > 0:
		...
		if velocity.x != 0:
			...
			if facing_right:
				...
				attack_shape2.position = Vector2(48.5, attack_shape2.position.y)
				attack_shape3.position = Vector2(36.5, attack_shape2.position.y)
				...
				attack_shape2.position = Vector2(18.5, attack_shape2.position.y) 
				attack_shape3.position = Vector2(30.5, attack_shape3.position.y)
