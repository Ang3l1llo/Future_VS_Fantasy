	...
	if velocity.length() > 0:
		...
		if velocity.x != 0:
			...
			if facing_right:
				...
				attack_shape3.position = Vector2(40.5, attack_shape3.position.y)
				...
				attack_shape2.scale.x = -1
				attack_shape3.scale.x = -1
				attack_shape1.position = Vector2(22, attack_shape1.position.y)  
				attack_shape2.position = Vector2(25, attack_shape2.position.y) 
