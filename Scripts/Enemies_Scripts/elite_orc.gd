	...
	if velocity.length() > 0:
		...
		if velocity.x != 0:
			...
			if facing_right:
				...
				attack_shape1.position = Vector2(47.5, attack_shape1.position.y)
				attack_shape2.position = Vector2(35, attack_shape2.position.y)
				attack_shape3.position = Vector2(49.5, attack_shape3.position.y)
				...
				attack_shape2.position = Vector2(33, attack_shape2.position.y) 
				attack_shape3.position = Vector2(18.5, attack_shape3.position.y)
