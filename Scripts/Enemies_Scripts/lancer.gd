	...
	if velocity.length() > 0:
		...
		if velocity.x != 0:
			...
			if facing_right:
				...
				attack_shape1.position = Vector2(57, attack_shape1.position.y)
				attack_shape2.position = Vector2(55, attack_shape2.position.y)
				attack_shape3.position = Vector2(58.5, attack_shape3.position.y)
				...
				attack_shape2.scale.x = -1
				attack_shape3.scale.x = -1
				attack_shape1.position = Vector2(11, attack_shape1.position.y)  
				attack_shape2.position = Vector2(13, attack_shape2.position.y) 
				attack_shape3.position = Vector2(10.5, attack_shape3.position.y)
