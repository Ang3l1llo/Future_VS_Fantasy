	...
	if velocity.length() > 0:
		...
		if velocity.x != 0:
			...
			if facing_right:
				...
				attack_shape3.position = Vector2(54.5, attack_shape3.position.y)
				...
				attack_shape2.position = Vector2(19, attack_shape2.position.y) 
				attack_shape3.position = Vector2(13.5, attack_shape3.position.y)
